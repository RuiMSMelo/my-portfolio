...
import cvPDFenglish from '../img/cvs/CV_eng.pdf'
...
function About() {
    ...
    return (
        <div className='allpages'>
            ...
            <p>
                Hey, I'm Rui Serôdio Melo, a web developer with a profound
                ...
                <br />
                <br />
                This portfolio is where I showcase my projects and continuously
                improve them.
                <br />
                In the future, I'll also feature projects I'm currently working
                on. It's a space that evolves with my journey, reflecting my
                commitment to progress in web development.
                <br />
                <br />
                <br />
                <br />
